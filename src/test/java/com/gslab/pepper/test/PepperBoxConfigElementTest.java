...
public class PepperBoxConfigElementTest {
	...
	public void validateSchemaProcessor() {
		...
		try {
			...
			Assert.assertTrue("Failed to generate Iterator from input schema",
					schemaProcessor.getPlainTextMessageIterator(TestInputUtils.testSchema) instanceof Iterator);
