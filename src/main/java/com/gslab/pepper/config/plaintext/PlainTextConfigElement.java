...
/**
 * The PlainTextConfigElement custom jmeter config element. This class acts as
 * plain text feeder to jmeter java sampler, it includes plaintext load
 * generator which takes input schema and generates messages.
 *
...
public class PlainTextConfigElement extends ConfigTestElement implements TestBean, LoopIterationListener {
	...
	/**
	 * For every JMeter sample, iterationStart method gets invoked, it initializes
	 * load generator and for each iteration sets new message as JMeter variable
	 *
