...
/**
 * The ClassPropertyEditor is custom UI component for SerializedConfigElement
 * class. This UI records class name and populates fields in table.
 *
...
public class ClassPropertyEditor extends PropertyEditorSupport implements ActionListener, TestBeanPropertyEditor, ClearGui {
	...
	// This will accept class name and button will load class properties in table
	// editor
	...
	public void actionPerformed(ActionEvent actionEvent) {
		...
		try {
			...
			// From TestBeanGUI retrieve Bean Customizer as it includes all editors like
			// ClassPropertyEditor, TableEditor
			...
			JOptionPane.showMessageDialog(null, "Failed to load class properties : " + e.getMessage(), "ERROR: Failed to load class properties!",
					JOptionPane.ERROR_MESSAGE);
			log.error("Failed to load class properties", e);
		}
